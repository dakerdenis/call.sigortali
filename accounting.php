        ...
        <div class="row">
            ...
            <div class="col-lg-3 grid-margin stretch-card">
                <? if($userGroup == 1 || $userGroup == 2){ ?>
                    ...
                    <button class="search_account btn btn-primary" data-id="Borclular" style="width: auto; margin: 5px;" type="button">Borclular</button>
                <? } ?>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Səhifə yükləndikdə borclular parametrini təmizləyirik
    ...
    function load_data(page, query = '', limit = '', params = '') {
        ...
        // Əgər params boşdursa, sessionStorage-dan alırıq
        if (!params) {
    ...
    $(document).on('click', '.search_account', function() {
        var id = $(this).data('id');
        // Borclular parametrini sessionStorage-da saxlayırıq
