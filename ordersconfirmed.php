    ...
    <div class="projects-section">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 grid-margin stretch-card">
                ...
                <? } ?>
                <a href="/orders" class="btn btn-primary"><?= lang('Təsdiq gözləyənlər'); ?></a>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#search').on('submit', (function(e) {
            ...
            load_data(1, query, limit, 'yes');

        }));

    });

    function load_data(page, query = '', limit = '', confirmed = 'yes', params = '') {
    ...
    $(document).on('click', '.page-link', function() {
        ...
        var query = $(".search-input").val();
        var limit = $('#limit').val();
        load_data(page, query, limit, 'yes');
    });

    $(document).on('click', '.search_account', function() {
        var id = $(this).data('id');
        load_data(1, '', 1000, 'yes', id);
    });
